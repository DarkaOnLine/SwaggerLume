...
<head>
    ...
    <script src='{{config('swagger-lume.paths.assets_public')}}/swagger-ui.min.js' type='text/javascript'></script>
    ...
    <div class="swagger-ui-wrap">
        <a id="logo" href="http://swagger.io">
            <img class="logo__img" alt="swagger" height="30" width="30"
                 src="{{config('swagger-lume.paths.assets_public')}}/images/logo_small.png" />
